    ...
    return (
        <div className="flex max-h-screen overflow-hidden bg-[#0a0a0a]">
            <div className="flex w-full h-full">
                {/* Chat Sidebar */}
                <div className="flex-[1] max-w-md border-r border-gray-800/50">
                    <Sidebar chatId={0} chats={_chats} />
                </div>

                {/* Main Dashboard Content */}
                <div className="flex-[8] max-h-screen overflow-y-auto p-8 md:p-12">
                                ...
                                {_chats.slice(0, 4).map(chat => (
                                    ...
                                    >
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <h4 className="font-medium text-gray-200 truncate group-hover:text-cyan-400 transition-colors">
                                                {chat.pdfName}
                                            </h4>
